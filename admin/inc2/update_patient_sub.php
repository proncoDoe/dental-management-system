...
if(isset($_POST['Update'])){
   ...
   if(mysqli_query ($conn, "UPDATE users SET   patient_id = $patient_id, fname = '$fname', lname ='$lname', contact ='$contact', email ='$email',address ='$address' WHERE patient_id = '$the_get_patient'") or die(mysqli_error($conn))){
    ...
    header('location: inc2/viewpatient_sub.php');
    exit();
...
<div class="col-lg-6 col-sm-12 mx-4">
    ...
    <p><a href="viewpatient_sub.php" class="btn btn-light btn-lg my-3 text-bold" roll="button">Back</a></p>
    ...
    <h2 class="card-title">Update Patient</h2>
        ...
        <input  type="text"  value="<?php echo $patient_id; ?>"  name="patient_id" class="form-control">
        ...
        <textarea name="address" id="body" class="form-control"><?php echo $address; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <button type="submit" name="Update"  class="btn btn-primary sub"  value="Update Patient">Update Patient</button>
