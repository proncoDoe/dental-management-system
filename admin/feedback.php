    ...
    <div class="row">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-10 mx-4">
                ...
                echo "<td><a class='btn btn-danger btn-sm delete' style='border-radius: 5%;'  href='feedback.php?delete={$feedback_id}'> <i class='fa fa-trash-alt fa-2x'></i></a></td>";
                echo '</tr>';
            ...
            <div class="col-lg-12">
                ...
                <div class="container">
                    ...
                    if($page > 1){
                        ...
                        echo "<li class='page-item'><a class='page-link ' href='feedback.php?page=".($page -1)."'>   
