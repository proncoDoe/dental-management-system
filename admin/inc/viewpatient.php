    ...
    <main>
        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-primary mb-3">
            <div class="flex-row d-flex">
                ...
                <a class="navbar-brand" href="../dashboard.php" title="Admin"> <i class="fa fa-tachometer-alt"></i>
                    Supper
                    Admin</a>
            </div>
                            ...
                            <div class="col-lg-12 text-light">
                                ...
                                <table class="table table-responsive-lg table-condensed table-hover">
                                    ...
                                    if(isset($_GET['page'])){
                                                      ...
                                                      echo '<td>'.$sex.'</td>';
                                                      echo '<td>'.$date.'</td>';
                                                      echo  "<td><a  class='btn btn-amber btn-sm edit' style='border-radius: 5%;'  href='update_patient.php?edit={$patient_id}'> <i class='fas fa-user-edit fa-2x'></i></a></td>";
                                                      echo "<td><a class='btn btn-danger btn-sm delete' style='border-radius: 5%;'  href='viewpatient.php?delete={$patient_id}'> <i class='fa fa-trash-alt fa-2x'></i></a></td>";
...
echo "<li class='page-item  bg-light'><a class='page-link active_link light text-primary' href='viewpatient.php?page=".$i."'>$i</a></li>";
