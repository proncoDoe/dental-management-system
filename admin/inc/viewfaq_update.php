...
<div class="col-lg-6 col-sm-12 mx-4">
    ...
    <p><a href="viewpatient.php" class="btn btn-light btn-lg my-3 text-bold" roll="button">Back</a></p>
    ...
    <h2 class="card-title">Update faQ</h2>
        ...
        <div class="form-group">
                         ...
                         <textarea name="faq_content" id="" class="form-control" autocomplete="off" autocapitalize="on"><?php echo $faq_content; ?></textarea>
                         ...
                         <textarea name="faq_text"  id="body" class="form-control" rows="7" cols="20"><?php echo $faq_text; ?></textarea>
