...
<nav class="navbar fixed-top navbar-expand-md navbar-dark bg-primary mb-3">
        ...
        <div class="navbar-collapse collapse" id="collapsingNavbar">
            ...
            <a class="dropdown-item" href="viewvendor.php">View Vendor</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="viewappointment.php">View Appointment's</a>
    ...
    <ul class="nav navbar-right top-nav text-light">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <small> <?php echo $_SESSION['fname']. " ". $_SESSION['lname'] ?></small> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="../inc/logout_vendor.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
        </li>
    </ul>
