...
<body>
    ...
    if(isset($_POST['Submit'])){
      ...
      $sex = ($sex);
       ...
       if(!$type === 'Cardiology' || !$type === 'dentist' || !$type === 'bones' || !$type === 'sugery'){
    ...
    }else if(vendor_exist($email, $conn)){
      ...
      foreach($location as $loc){
        ...
        $statement = "INSERT INTO vendor(`type`,`fname`,`lname`,`email`,`vendor_roll`, `password`, `location`, `sex`,`created_at`) ";
        $statement .= "VALUE (?,?,?,?,?,?,?,?,?)";
        $stmt = $conn->prepare($statement);
        $stmt->bind_param("sssssssss", $type, $fname, $lname, $email, $vendor_roll, $password, $loc, $sex, $created_at);
        $stmt->execute();
    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="signup_vendor.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mt-2">
                                ...
                                <div class="form-group fontemail textItalic">
                                    ...
                                    <label class="text-muted"><?php echo _TYPE ?></label>

                                    <select name="type" class="form-control" required>

                                        <option value="" selected disabled><?php echo _SELECT_TYPE ?></option>
                                ...
                                <div class="form-group fontemail textItalic">
                                    ...
                                    <label class="text-muted" class="text-muted">Select Patient</label>
                                ...
                                <div class="form-group fontpassword textItalic">
                                    ...
                                    <label class="text-muted"><?php  echo _SELECT_YOUR_LOCATION ?></label>
                                    <select name="location[]" id="multiselector" class="form-control" required>

                                        <option value="" selected disabled><?php echo _LOCATION ?></option>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="options text-right">
                                    <p class="pt-1 text-muted"><?php echo _ALREADY_COUNT ?><a href="../index.php"
                                            class="blue-text" style="text-decoration: none;"><?php echo _SIGN ?></a></p>
                                </div>
